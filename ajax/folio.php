...
if($count == 1){
    echo '<div class="col-lg-4 folio_effect mix graphic">
            <div class="folio_item">
                <a href="rt.html" class="folio_item_thumbs">
                ...
                <div class="folio_content">
                    <h3 class="folio_title"><a href="rt.html">Design Structure</a></h3>
        ...
        <div class="col-lg-4 folio_effect mix app">
            <div class="folio_item">
                ...
                <div class="folio_content">
                    <h3 class="folio_title"><a href="rt.html">Animation App</a></h3>
        ...
        <div class="col-lg-4 folio_effect mix illustrtopm">
            <div class="folio_item">
                ...
                <div class="folio_content">
                    <h3 class="folio_title"><a href="rt.html">Super Hero Illustration</a></h3>
    ...
    echo '<div class="col-lg-4 folio_effect mix dev">
            <div class="folio_item">
                ...
                <div class="folio_content">
                    <h3 class="folio_title"><a href="rt.html">Online Software</a></h3>
        ...
        <div class="col-lg-4 folio_effect mix graphic">
            <div class="folio_item">
                ...
                <div class="folio_content">
                    <h3 class="folio_title"><a href="rt.html">Info Graphic Design</a></h3>
                    <p class="folio_cat"><a href="portfolio.html">Graphic</a></p>
                </div>
            </div>
        </div>
        <div class="col-lg-4 folio_effect mix illustrtopm">
            <div class="folio_item">
                ...
                <div class="folio_content">
                    <h3 class="folio_title"><a href="rt.html">Abstract Elements</a></h3>
